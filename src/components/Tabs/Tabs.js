...
export const Tabs = ({ activeTabName, onClickTab }) => {
  const { CANCEL_AT_ANY_TIME, WATCH_ANYWHERE, PICK_YOUR_PRICE } = tabLabeles;
    ...
    <>
      <section className="tabs">
        <div className="container">
          {renderTabTitle
            (CANCEL_AT_ANY_TIME, activeTabName === CANCEL_AT_ANY_TIME,
              "fas fa-door-open fa-3x",
              "tab-1")}
          {renderTabTitle
            (WATCH_ANYWHERE, activeTabName === WATCH_ANYWHERE,
              "fas fa-tablet-alt fa-3x",
              "tab-2")}
          {renderTabTitle
            (PICK_YOUR_PRICE, activeTabName === PICK_YOUR_PRICE,
              "fas fa-tags fa-3x",
              "tab-2")}
        </div>
      </section>
          ...
          <section className="tab-content">
            ...
            >
              <div className="tab-2-content-top">
                <p className="text-lg">
                  Wathc TV shows and movies anytime, anywhere-personalized for
                  you.
                </p>
                <Link to="/netflix-show" className="btn btn-lg">
                  Watch Free For 30 Days
              ...
              <div className="tab-2-content-bottom">
                ...
                <div>
                  ...
                  alt=""/>
                  <p className="text-md">
                    Watch instantly or downdload for later
                  </p>
                  <p className="text-dark">
            ...
            className={`tab-content-item ${
              activeTabName === PICK_YOUR_PRICE && "show"}`}>
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      <td>Mothly price after free month ends on 12/05/2023</td>
                      <td>$6.99</td>
                      <td>$11.99</td>
                      <td>$15.99</td>
                    </tr>
                    <tr>
                      <td>HD Available</td>
                      <td><i className="fas fa-times"></i>
                      </td>
                      <td><i className="fas fa-check"></i>
                      </td>
                      <td><i className="fas fa-check"></i>
                      </td>
                      </tr>
                      ...
                      <tr>
                      <td> Ultimate movies and TV show</td>
                      <td><i className="fas fa-check"></i>
                      </td>
                      <td><i className="fas fa-check"></i>
                      </td>
